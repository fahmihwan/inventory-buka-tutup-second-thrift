            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="/supplier-customer/supplier" method="POST" class="form form-vertical">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="address"
                                                    ...
                                                    is-invalid
                                                @enderror"
                                                    id="alamat" placeholder="alamat" value="{{ old('address') }}"
                                                    required>
                                                @error('address')
                                                    <div class="valid-feedback">
                                                        <i class="bx bx-radio-circle"></i>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone_number"
                                                 ...
                                                 @error('phone_number')
                                                    is-invalid
                                                @enderror "
                                                    id="telp" placeholder="nomor hp" value="{{ old('phone_number') }}"
                                                    required>
                                                @error('phone_number')
                                                    <div class="valid-feedback">
                                                        <i class="bx bx-radio-circle"></i>
