                        ...
                        <form action="/master/detail-brand" method="post" class="form form-vertical">
                            ...
                            <div class="modal-content">
                                <div class="modal-header p-2">
                                    <h5 class="modal-title" id="myModalLabel1">Input Detail Brand</h5>
                        ...
                        @foreach ($detail_brand as $detail)
                            <tr class="p-0 m-0 ">
                                ...
                                <td style="padding: 0px;">
                                    <a href="/master/detail-brand/{{ $detail->id }}/edit"
                                        class="btn badge btn-sm round btn-warning ">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                    <form action="/master/detail-brand/{{ $detail->id }}" method="post"
